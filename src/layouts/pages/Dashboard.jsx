...
import { FaPlus, FaTrashCan, FaPaperPlane } from 'react-icons/fa6'
            ...
            {loading ? (
                        ...
                        <div className="grid gap-y-4">
                            ...
                            >
                                ...
                                <input
                                    ...
                                    onChange={handleUpdateUserInputsChange}
                ...
                >
                    ...
                    <input
                        ...
                        onChange={handleUpdateUserInputsChange}
                        className="border rounded-xl h-16 w-full p-4 col-span-10"
                        // Make the textarea read-only to prevent editing
                    />
                ...
                <div className="grid grid-cols-12 gap-x-4">
                    ...
                    <div className="col-span-1 h-min shadow-md rounded-3xl grid gap-4 px-2 py-4 w-max items-center">
                        <button>
                            <FaPlus size={22} />
                        </button>
                        <button>
